...
class AddToPlaylistFragment : DialogFragment() {
    ...
    private val loadPlaylistsTask = object : AsyncTask<Void, Int, Tuple<Array<CharSequence?>, BooleanArray>>() {
        override fun doInBackground(vararg voids: Void): Tuple<Array<CharSequence?>, BooleanArray> {
