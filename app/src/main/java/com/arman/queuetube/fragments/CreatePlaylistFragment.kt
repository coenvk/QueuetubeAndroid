...
class CreatePlaylistFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        this.editText = view.findViewById<View>(R.id.create_playlist_dialog_input) as EditText
        this.errorText = view.findViewById<View>(R.id.create_playlist_dialog_error_text) as TextView
